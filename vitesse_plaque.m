function  [Uq] = vitesse_plaque(Xq, Yq, Zq, component) %fonction qui renvoie les composantes de vitesse aux points (Xq, Yq, Zq) connaissant les vitesses aux points du maillage
