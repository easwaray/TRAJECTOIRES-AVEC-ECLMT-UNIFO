function [t,x] = principal_deterministe_sphere;
time= cputime;
variables_sphere;
global Xin
...
[t, x]=ode23('equations_physiques_sphere', xspan, Xin);
...
if size(F,1)==0 
    ...
    Pr1= empreinte_trajectoire_sphere(x_traj,y_traj,z_traj, X_Plan);
    Pr2= empreinte_trajectoire_sphere(x_traj,y_traj,z_traj, 2*X_Plan);
